...
public class UserController {
    ...
    public ResponseEntity<LoginResponse> updatePassword(String accountId, @RequestBody UserUpdatePasswordRequest userUpdatePasswordRequest,
                                                        HttpSession httpSession) {
        ResponseEntity<LoginResponse> responseEntity = null;

        String id = accountId; // SessionUtil.getLoginMemberId(httpSession);
